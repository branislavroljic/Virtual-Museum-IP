...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<Object> handleBadCredentialsException(BadCredentialsException e, HandlerMethod handlerMethod) {
        return new ResponseEntity<>("Invalid credentials or account is not active!", HttpStatus.UNAUTHORIZED);
    }
    ...
    public final ResponseEntity<Object> handleException(Exception e, HandlerMethod handlerMethod) {
        e.printStackTrace();
        return new ResponseEntity<>("An error occurred while performing action!", HttpStatus.INTERNAL_SERVER_ERROR);
    }
